...
public class MaterialNavBarOld extends Composite {

	private static MaterialNavBarUiBinder uiBinder = GWT
			.create(MaterialNavBarUiBinder.class);

	interface MaterialNavBarUiBinder extends UiBinder<Widget, MaterialNavBarOld> {
	}
	...
	/**
	 * Type of Nav Bar 
	 * fixed  - will show the sidebar plus the app toolbar
	 * default - will hide the a
	 * @param type
	 */
