...
public class MaterialLink3 extends FocusPanel implements HasGrid, HasSeparator, HasActivates, HasWaves{
	...
	public MaterialLink3() {
		// TODO Auto-generated constructor stub
	}

	public MaterialLink3(String text, String textColor) {
		super();
		setText(text);
	...
	public MaterialLink3(String text) {
		super();
		this.text = text;
	}
