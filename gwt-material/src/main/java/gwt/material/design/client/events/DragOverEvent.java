...
public class DragOverEvent extends GwtEvent<DragOverEvent.DragOverHandler> {

    public interface DragOverHandler extends EventHandler {
        void onDragOver(DragOverEvent event);
    }

    public static final Type<DragOverHandler> TYPE = new Type<>();
    ...
    public static void fire(HasHandlers source) {
        source.fireEvent(new DragOverEvent());
    }
