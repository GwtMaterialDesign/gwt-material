...
public class ClosingEvent extends GwtEvent<ClosingEvent.ClosingHandler> {

    public interface ClosingHandler extends EventHandler {
        void onClosing(ClosingEvent event);
    }

    public static final Type<ClosingHandler> TYPE = new Type<>();
    ...
    public static void fire(HasHandlers source) {
        source.fireEvent(new ClosingEvent());
    }
