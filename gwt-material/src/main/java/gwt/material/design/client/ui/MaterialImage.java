 ...
 */
//@formatter:on
public class MaterialImage extends AbstractValueWidget<String> implements HasCaption, HasType<ImageType>, HasImage,
    ...
    public void setUrl(String url, String fallbackUrl) {
