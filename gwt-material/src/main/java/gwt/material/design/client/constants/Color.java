...
public enum  Color implements CssType {
    ...
    // Light Blue
    LIGHT_BLUE_LIGHTEN_5("light_blue lighten-5"),
    LIGHT_BLUE_LIGHTEN_4("light_blue lighten-4"),
    LIGHT_BLUE_LIGHTEN_3("light_blue lighten-3"),
    LIGHT_BLUE_LIGHTEN_2("light_blue lighten-2"),
    LIGHT_BLUE_LIGHTEN_1("light_blue lighten-1"),
    LIGHT_BLUE("light_blue"),
    LIGHT_BLUE_DARKEN_1("light_blue darken-1"),
    LIGHT_BLUE_DARKEN_2("light_blue darken-2"),
    LIGHT_BLUE_DARKEN_3("light_blue darken-3"),
    LIGHT_BLUE_DARKEN_4("light_blue darken-4"),
    LIGHT_BLUE_ACCENT_1("light_blue accent-1"),
    LIGHT_BLUE_ACCENT_2("light_blue accent-2"),
    LIGHT_BLUE_ACCENT_3("light_blue accent-3"),
    LIGHT_BLUE_ACCENT_4("light_blue accent-4"),
    // Blue
    ...
    // Pink
    PINK_LIGHTEN_5("deep-purple lighten-5"),
    PINK_LIGHTEN_4("deep-purple lighten-4"),
    PINK_LIGHTEN_3("deep-purple lighten-3"),
    PINK_LIGHTEN_2("deep-purple lighten-2"),
    PINK_LIGHTEN_1("deep-purple lighten-1"),
    PINK("deep-purple"),
    PINK_DARKEN_1("deep-purple darken-1"),
    PINK_DARKEN_2("deep-purple darken-2"),
    PINK_DARKEN_3("deep-purple darken-3"),
    PINK_DARKEN_4("deep-purple darken-4"),
    PINK_ACCENT_1("deep-purple accent-1"),
    PINK_ACCENT_2("deep-purple accent-2"),
    PINK_ACCENT_3("deep-purple accent-3"),
    PINK_ACCENT_4("deep-purple accent-4"),
    // Red
